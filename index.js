...
/* (Oto test yok) Yukarıdaki CemberinCevresi fonksiyonunu yarıçap = 5 vererek aşağıda çalıştırıp, sonucu konsolda gözlemleyin 
(console.log)  */
...
- CemberinAlani fonksiyonunu kullanarak aşağıdaki yönergeleri uygulayın:
    ...
    içinde tanımlı Math kütüphanesini 
    kullanabilirsiniz. Math.pow(yaricap,2))
...
/* 	GÖREV 3:
  ...
  oluşturulmuş tam sayılar ve ondalıklı sayılar bulunmaktadır. Bu diziyi kullanarak aşağıdakileri uygulayın:
    ...
    oluşturulup `tekraredensayilar` dizisine aktarılmasını istiyoruz. Örnek string: "{sayı} sayısı {tekrarSayisi} kere 
    tekrar edilmiştir"
